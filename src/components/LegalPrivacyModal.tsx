...
import { LegalPrivacyContentRenderer } from "./LegalPrivacyContentRenderer";
import { LEGAL_PRIVACY_FR, LEGAL_PRIVACY_EN } from "../data/legalPrivacyData";
...
export const LegalPrivacyModal: React.FC<LegalPrivacyModalProps> = ({
  ...
  const currentData = language === "fr" ? LEGAL_PRIVACY_FR : LEGAL_PRIVACY_EN;

  const scrollToSection = (sectionId: string) => {
    const targetElement = document.getElementById(`legal-modal-${sectionId}`);
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="legal-privacy-modal-title"
    ...
    >
      ...
      >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#2D2D2D]/60 font-sans">
                  speakfrenchwitheva.com • {language === "fr" ? "Politique de confidentialité" : "Privacy Policy"}
                </p>
              </div>
            </div>
        ...
        >
          <LegalPrivacyContentRenderer
            language={language}
            containerIdPrefix="legal-modal"
            onContactClick={() => {
              onClose();
